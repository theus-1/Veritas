...
- **limites de requisição**: Imposição de rate-limit para evitar indisponibilidade do serviço.
...
Está dentro do escopo a conferência mais detalhada das notícias dadas pelos usuários, para que ele entenda se está sendo alvo de fake news ou não.

# Fora do escopo

Está fora do escopo tudo que se trata na postagem de notícias.
